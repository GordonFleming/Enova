    ...
    <div class="row">
        <div class="col-3">
            ...
            <ul>
                ...
                <li>Cleaning consumables & equipment</li>
                <li>Office consumables (snacks, beverages, etc)</li>
        ...
        <div class="col-3">
            ...
            <ul>
                ...
                <li>In-store demonstrations</li>
                <li>Merchandise advertising</li>
                <li>Customer engagements</li>
                <li>Samples & giveaways</li>
            </ul>
        </div>
        <div class="col-3">
